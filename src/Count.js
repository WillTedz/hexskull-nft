...
const Count = () => {
  ...
  itemsRedeemed ? (<div className='flex items-center mt-12 radious-0 '>
   ...
   <h3 className=" inline text-center text-white text-3xl font-semibold decoration-indigo-500/80 lg:text-left xl:text-4xl">
   Mint will start soon <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">{itemsRedeemed}/{itemsAvailable}</span></h3>
    </div>) :
  ...
  <span className="animate-ping inline-flex h-4 w-4 rounded-full bg-green-300 opacity-75 mr-3"></span>
   ...
   contract address: <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">Soon</span></h3>
    </div>)
  )
}
