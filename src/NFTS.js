...
<section
  ...
  id="gallery"
>
  <h3 className="mb-4 p-16 text-white text-center text-3xl font-semibold decoration-indigo-500/80 lg:text-left xl:text-4xl">
  ...
  <NFT img={'/images/11.png'}/>
  <NFT img={'/images/12.png'}/>
  <NFT img={'/images/13.png'}/>
  <NFT img={'/images/15.png'}/>
